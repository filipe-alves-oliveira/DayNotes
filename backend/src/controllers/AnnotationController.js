...
module.exports = {
    ...
    async read(request, response) { //operacao externa, executar de forma assincrona, esperar uma resposta - bd assync, espera a info voltar do bd e popular nossa variavel.
